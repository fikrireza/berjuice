...
@section('content')
<div id="product-show" class="setup-wrapper" style="background-image: url('{{ asset('amadeo/image/base/sparkling-water-bg.jpg') }}');">
	<div class="setup-content nor-wd">
		...
		<img id="show-product" src="{{ asset('amadeo/image/base/sparkling-water.png') }}">
		<h1 class="title">SPARKLING WATER</h1>
	</div>
</div>
