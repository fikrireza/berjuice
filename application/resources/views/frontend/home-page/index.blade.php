...
<div id="wtfuar" class="setup-wrapper" style="background-image: url('{{ asset('amadeo/image/base/wtfuar-bg.jpg') }}');">
	<div class="setup-content nor-wd">
		...
		<div class="for-wrapper centered for-wtfu">
			<div class="circle" style="background-image: url('{{ asset('amadeo/image/base/pic-sos-'.$a.'.jpg') }}');">
...
<div id="product" class="setup-wrapper">
	@php ( $arr = ['', 'FRESHLY SQUEEZED', 'PREMIUM CHILLED', 'VITTORIA COFFE'])
	@php ( $arrUrl = ['', 'premium-chilled', 'premium-chilled', 'victtoria-coffe'])
	@for($a=1; $a<=3; $a++)
	<div class="product-wrapper" style="background-image: url('{{ asset('amadeo/image/base/product-bg-'.$a.'.jpg') }}');">
		@if($a==1)
