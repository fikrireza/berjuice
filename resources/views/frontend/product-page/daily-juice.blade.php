...
@section('content')
	...
	<div id="product-decription" class="product-decription setup-wrapper dekstop">
		<div class="setup-content nor-wd">
			...
			<p class="description">
			Daily Juice is our latest product innovation for the Food Service industry. The glass bottle package ensure even distribution of temperature to sustain freshness and natural taste while maintaining elegant presentation at the same time.
			</p>
